...
const SensorsPage: React.FC = () => {
  ...
  const [activeCategory, setActiveCategory] = useState('Sensors & Components');
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          <p className={styles.heroEyebrow}>{t['catalog.eyebrow.sensors'] || '// SENSORS & COMPONENTS'}</p>
          <h1 className={styles.heroTitle}>{t['catalog.title.sensors'] || 'Sensors & Components'}</h1>
      ...
      <main className={styles.main}>
        {filtered.length > 0 ? (
          ...
          <div className={styles.empty}>
            ...
            <button className={styles.emptyReset} onClick={() => { setSearch(''); setActiveCategory('Sensors & Components'); setInStockOnly(false); }}>
