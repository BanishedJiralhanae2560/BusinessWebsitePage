...
const ALL_PRODUCTS: CatalogProduct[] = [
  ...
  { id: 7,  name: 'Product Name', category: 'Circuit Boards',          price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: 'NEW',       inStock: true,  description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
  { id: 8,  name: 'Product Name', category: 'Circuit Boards',          price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: undefined,   inStock: true,  description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
  { id: 9,  name: 'Product Name', category: 'Circuit Boards',          price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: undefined,   inStock: false, description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
  { id: 10, name: 'Product Name', category: 'Microchips & Processors', price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: 'SALE',      inStock: true,  description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
