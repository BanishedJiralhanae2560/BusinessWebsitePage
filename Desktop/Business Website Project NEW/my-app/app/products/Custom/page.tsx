...
const ALL_PRODUCTS: CatalogProduct[] = [
  ...
  { id: 7,  name: 'Product Name', category: 'Custom Solutions',             price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: 'NEW',       inStock: true,  description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
  { id: 8,  name: 'Product Name', category: 'Custom Solutions',             price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: undefined,   inStock: true,  description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
  { id: 9,  name: 'Product Name', category: 'Custom Solutions',             price: 0.00, originalPrice: 0.00, rating: 0, reviewCount: 0, badge: undefined,   inStock: false, description: 'Short product description goes here. Highlight key features or benefits in one to two sentences.' },
...
const CustomPage: React.FC = () => {
  ...
  const [activeCategory, setActiveCategory] = useState('Custom Solutions');
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          <p className={styles.heroEyebrow}>{t['catalog.eyebrow.custom'] || '// CUSTOM SOLUTIONS'}</p>
          <h1 className={styles.heroTitle}>{t['catalog.title.custom'] || 'Custom Solutions'}</h1>
      ...
      <main className={styles.main}>
        {filtered.length > 0 ? (
          ...
          <div className={styles.empty}>
            ...
            <button className={styles.emptyReset} onClick={() => { setSearch(''); setActiveCategory('Custom Solutions'); setInStockOnly(false); }}>
